...
const LANG = {
  en: {
    ...
    wizard_preview_title: "Preview Your Setup",
    wizard_preview_desc: "Listen to your TTS voice and see visual provider samples before starting.",
    wizard_preview_tts: "Voice Preview",
    wizard_preview_tts_desc: "Hear how your selected TTS voice sounds",
    wizard_preview_visuals: "Visual Style Preview",
    wizard_preview_visuals_desc: "Preview of your selected visual provider output",
    wizard_preview_summary: "Configuration Summary",
    next_btn: "Continue",
    prev_btn: "Back",
    ...
    nav_channels: 'Channels', nav_gallery: 'Gallery',
    nav_content_planning: 'Content Planning',
    nav_group_main: 'Main', nav_group_content: 'Content', nav_group_analytics: 'Analytics', nav_group_system: 'System',
    ...
    dashboard_this_week: 'This Week', dashboard_week_total: 'Total', dashboard_week_completed: 'Completed', dashboard_week_failed: 'Failed', dashboard_week_active: 'Active',
    dashboard_by_channel: 'By Channel', dashboard_upcoming: 'Upcoming Content', dashboard_view_calendar: 'View Calendar →',
    dashboard_produce: 'Produce', dashboard_no_upcoming: 'No upcoming content', calendar_produce_started: 'Video production started!',
    ...
    pr_wizard_step1: 'Product Info', pr_wizard_step2: 'Review', pr_wizard_step3: 'Narration', pr_wizard_step4: 'Render',
    ...
    // Onboarding
    onb_welcome_title: 'Welcome to YTRobot!',
    onb_welcome_desc: 'Let\'s set up your automated YouTube video studio in a few simple steps.',
    onb_start: 'Let\'s Begin',
    onb_back: 'Back',
    onb_next: 'Continue',
    onb_channel_title: 'Create Your Channel',
    onb_channel_desc: 'Set up your first channel with brand identity.',
    onb_channel_name: 'Channel Name',
    onb_channel_name_ph: 'My Channel',
    onb_channel_lang: 'Language',
    onb_color_primary: 'Primary Color',
    onb_color_secondary: 'Secondary Color',
    onb_brand_preview: 'Brand Preview',
    onb_tts_title: 'Choose Voice Engine',
    onb_tts_desc: 'Select the text-to-speech engine for your videos.',
    onb_tts_edge_desc: 'Free, 300+ voices, no API key needed',
    onb_tts_qwen3_desc: 'Local AI model, high quality, no key needed',
    onb_tts_eleven_desc: 'Premium quality, natural sounding voices',
    onb_tts_openai_desc: 'Fast, stable, good quality voices',
    onb_tts_spesh_desc: 'ElevenLabs compatible, premium voices',
    onb_tts_dub_desc: 'Alternative TTS provider',
    onb_quality: 'Quality',
    onb_voice_title: 'Select Your Voice',
    onb_voice_desc: 'Choose a voice and listen to previews.',
    onb_voice_api_note: 'Voices will be available after API key is configured in Settings.',
    onb_speed: 'Speech Speed',
    onb_visual_title: 'Choose Visual Source',
    onb_visual_desc: 'Where should the scene visuals come from?',
    onb_vis_pexels_desc: 'Free stock video clips from Pexels library',
    onb_vis_zimage_desc: 'AI-generated images via KIE.AI',
    onb_vis_dalle_desc: 'OpenAI DALL-E 3 AI image generation',
    onb_vis_poll_desc: 'Free AI image generation, no key needed',
    onb_style_title: 'Set Video Style',
    onb_style_desc: 'Configure resolution, effects, and subtitle animations.',
    onb_resolution: 'Resolution',
    onb_subtitle_anim: 'Subtitle Animation',
    onb_video_effect: 'Video Effect',
    onb_font: 'Subtitle Font',
    onb_composer: 'Video Engine',
    onb_simple: 'Simple',
    onb_advanced: 'Advanced',
    onb_complete_title: 'Setup Complete!',
    onb_complete_desc: 'You can change any setting later from the Settings page.',
    onb_preview_title: 'Output Preview',
    onb_preview_audio: 'Audio Preview',
    onb_preview_voice: 'Voice',
    onb_preview_speed: 'Speed',
    onb_preview_listen: 'Listen Preview',
    onb_preview_generating: 'Generating...',
    // Gallery
    // Wizard Config Step Names
    onb_wizard_step_welcome: 'Welcome',
    onb_wizard_step_channel: 'Channel Setup',
    onb_wizard_step_tts_provider: 'TTS Provider',
    onb_wizard_step_voice_select: 'Voice Selection',
    onb_wizard_step_visual_provider: 'Visual Provider',
    onb_wizard_step_video_style: 'Video Style',
    onb_wizard_step_tts_advanced: 'TTS Advanced',
    onb_wizard_step_subtitle_detail: 'Subtitle & Camera',
    onb_wizard_step_ai_system: 'AI & System',
    onb_wizard_step_api_keys: 'API Keys',
    onb_wizard_step_notifications: 'Notifications',
    onb_wizard_step_social_meta: 'Social Media',
    onb_wizard_step_youtube_oauth: 'YouTube',
    onb_wizard_step_module_tts: 'Module TTS',
    onb_wizard_step_module_settings: 'Module Settings',
    onb_wizard_step_summary: 'Summary',
    gallery_title: 'Video Gallery',
    gallery_search: 'Search...',
    gallery_all: 'All',
    gallery_completed: 'Completed',
    gallery_failed: 'Failed',
    gallery_all_modules: 'All Modules',
    gallery_all_channels: 'All Channels',
    gallery_default_channel: 'Default',
    gallery_results: 'results',
    gallery_empty: 'No videos created yet',
    gallery_load_more: 'Load more',
    onb_summary_channel: 'Channel',
    onb_summary_tts: 'Voice Engine',
    onb_summary_visual: 'Visual Source',
    onb_summary_style: 'Video Style',
    onb_create_first: 'Create My First Video!',
    onb_go_dashboard: 'Go to Dashboard',
    onb_tts_advanced_title: 'TTS Advanced Settings',
    onb_tts_advanced_desc: 'Fine-tune your text-to-speech settings',
    onb_remove_apostrophes: 'Remove Apostrophes',
    onb_remove_apostrophes_desc: 'Strip apostrophes to prevent micro-pauses',
    onb_trim_silence: 'Trim Silence',
    onb_trim_silence_desc: 'Remove leading/trailing silence from audio',
    onb_tts_enhance: 'Enhance with AI',
    onb_tts_enhance_desc: 'Use Gemini to add emphasis and pauses',
    onb_tts_workers: 'Concurrent Workers',
    onb_spesh_language: 'Language Code',
    onb_spesh_voice_id: 'Voice ID',
    onb_subtitle_detail_title: 'Subtitle & Camera Details',
    onb_subtitle_detail_desc: 'Customize subtitle appearance and camera movements',
    onb_sub_size: 'Subtitle Size',
    onb_sub_color: 'Subtitle Color',
    onb_sub_bg: 'Subtitle Background',
    onb_sub_stroke: 'Text Stroke',
    onb_karaoke_enabled: 'Karaoke Mode',
    onb_karaoke_desc: 'Highlight words as they are spoken',
    onb_karaoke_color: 'Karaoke Highlight Color',
    onb_transition_dur: 'Transition Duration',
    onb_ken_burns_zoom: 'Ken Burns Zoom',
    onb_ken_burns_dir: 'Ken Burns Direction',
    onb_ai_system_title: 'AI & System Settings',
    onb_ai_system_desc: 'Configure script generation and system performance',
    onb_target_audience: 'Target Audience',
    onb_target_audience_ph: 'e.g. beginner YouTubers under 1k subscribers',
    onb_script_humanize: 'Humanize Script',
    onb_script_humanize_desc: 'Rewrite script for natural speech with Gemini',
    onb_gpu_encoding: 'GPU Encoding',
    onb_subtitle_provider: 'Subtitle Provider',
    onb_remotion_concurrency: 'Remotion Concurrency',
    onb_api_keys_title: 'API Keys',
    onb_api_keys_desc: 'Enter your API keys for various services (optional, can be added later)',
    onb_yt_api_key_desc: 'For competitor analysis scanning',
    onb_pixabay_desc: 'Alternative stock visuals',
    onb_youtube_title: 'YouTube & Publishing',
    onb_youtube_desc: 'Configure YouTube upload and social media publishing',
    onb_autopublish_yt: 'Auto-publish to YouTube',
    onb_yt_privacy: 'Default Privacy Status',
    onb_yt_category: 'YouTube Category',
    onb_notif_title: 'Notifications',
    onb_notif_desc: 'Set up notification channels for video completion/failure',
    onb_social_meta_title: 'Social Media Metadata',
    onb_social_meta_desc: 'Auto-generate social media metadata for your videos',
    onb_social_yt_video: 'Enable for YT Videos',
    onb_social_bulletin: 'Enable for Bulletins',
    onb_social_pr: 'Enable for Product Reviews',
    onb_social_fields: 'Metadata Fields',
    onb_social_prompt: 'Master Prompt',
    onb_social_prompt_ph: 'Custom instructions for metadata generation...',
    onb_social_lang: 'Metadata Language',
    onb_module_override_title: 'Module TTS Overrides',
    onb_module_override_desc: 'Set different TTS settings per module (leave empty to use global defaults)',
    onb_override_tts_provider: 'TTS Provider',
    onb_modules_title: 'Module Settings',
    onb_modules_desc: 'Configure Bulletin and Product Review module defaults',
    onb_bulletin_settings: 'Bulletin Settings',
    onb_bulletin_network: 'Network Name',
    onb_bulletin_style: 'Bulletin Style',
    onb_bulletin_max_items: 'Max Items',
    onb_bulletin_lang: 'Default Language',
    onb_pr_settings: 'Product Review Settings',
    onb_pr_style: 'Review Style',
    onb_pr_currency: 'Currency',
    onb_pr_auto_tts: 'Auto-generate TTS',
    onb_pr_master_prompt: 'Master Prompt',
    onb_pr_master_prompt_ph: 'Custom AI extraction instructions...',
    onb_pr_ai_lang: 'AI Language',
    onb_summary_subtitle: 'Subtitle',
    onb_summary_effects: 'Effects',
    onb_summary_notif: 'Notifications',
    onb_summary_modules: 'Modules',
    // Sidebar groups
    nav_group_main: 'Main',
    ...
    playlist_create_error: 'Could not create playlist',
    video_deleted: 'Video deleted',
    delete_error: 'Delete failed',
    yt_upload_started: 'YouTube upload started',
    yt_upload_error: 'YouTube upload error',
    thumbnail_created: 'Thumbnail created',
    thumbnail_error: 'Thumbnail error',
    ai_metadata_created: 'AI metadata generated',
    ai_metadata_error: 'Could not generate AI metadata',
    ai_assist_applied: 'AI suggestion applied',
    ai_error: 'AI error',
    file_type_error: 'Only .txt, .json, .srt files are supported',
    tts_preview_btn: 'Generate TTS Preview',
    tts_preview_error: 'Could not generate voice preview',
    wizard_config_saved: 'Wizard configuration saved',
    wizard_config_reset: 'Wizard reset to defaults',
    schedule_select_video: 'Please select a video',
    schedule_select_date: 'Please select a date',
    video_scheduled: 'Video scheduled',
    form_field_required: 'This field is required',
    form_title_required: 'Please enter a title',
    form_min_variants: 'At least 2 variants required',
  },
  tr: {
    ...
    wizard_step_preview: "Önizleme",
    wizard_step_confirm: "Son Onay",
    wizard_preview_title: "Kurulumunuzu Önizleyin",
    wizard_preview_desc: "Başlamadan önce TTS sesinizi dinleyin ve görsel provider örneklerini görün.",
    wizard_preview_tts: "Ses Önizleme",
    wizard_preview_tts_desc: "Seçtiğiniz TTS sesinin nasıl duyulduğunu dinleyin",
    wizard_preview_visuals: "Görsel Stil Önizleme",
    wizard_preview_visuals_desc: "Seçtiğiniz görsel provider çıktı örneği",
    wizard_preview_summary: "Yapılandırma Özeti",
    next_btn: "Devam Et",
    prev_btn: "Geri Dön",
    ...
    nav_channels: 'Kanallar', nav_gallery: 'Galeri',
    nav_content_planning: 'İçerik Planlama',
    nav_group_main: 'Ana İşlemler', nav_group_content: 'İçerik', nav_group_analytics: 'Analiz', nav_group_system: 'Sistem',
    ...
    dashboard_this_week: 'Bu Hafta', dashboard_week_total: 'Toplam', dashboard_week_completed: 'Tamamlanan', dashboard_week_failed: 'Başarısız', dashboard_week_active: 'Aktif',
    dashboard_by_channel: 'Kanallara Göre', dashboard_upcoming: 'Yaklaşan İçerikler', dashboard_view_calendar: 'Takvime Git →',
    dashboard_produce: 'Üret', dashboard_no_upcoming: 'Yaklaşan içerik yok', calendar_produce_started: 'Video üretimi başladı!',
    ...
    pr_wizard_step1: 'Ürün Bilgileri', pr_wizard_step2: 'Değerlendirme', pr_wizard_step3: 'Seslendirme', pr_wizard_step4: 'Render',
    pr_mode_manual: 'Manuel Giriş',
    pr_auto_title: '✨ Auto — URL ile AI Doldur',
    pr_auto_header_sub: 'Ürün linkini ver, AI tüm alanları otomatik doldursun',
    pr_manual_header_sub: 'Tüm ürün bilgilerini kendin gir ve videoyu render et',
    ...
    // Onboarding
    onb_welcome_title: 'YTRobot\'a Hoşgeldin!',
    onb_welcome_desc: 'Birkaç basit adımda otomatik YouTube video stüdyonuzu kuralım.',
    onb_start: 'Başlayalım',
    onb_back: 'Geri',
    onb_next: 'Devam Et',
    onb_channel_title: 'Kanalını Oluştur',
    onb_channel_desc: 'Marka kimliğiyle birlikte ilk kanalını kur.',
    onb_channel_name: 'Kanal Adı',
    onb_channel_name_ph: 'Kanalım',
    onb_channel_lang: 'Dil',
    onb_color_primary: 'Ana Renk',
    onb_color_secondary: 'İkincil Renk',
    onb_brand_preview: 'Marka Önizlemesi',
    onb_tts_title: 'Ses Motorunu Seç',
    onb_tts_desc: 'Videolarınız için kullanılacak seslendirme motorunu seçin.',
    onb_tts_edge_desc: 'Ücretsiz, 300+ ses, API key gerekmez',
    onb_tts_qwen3_desc: 'Yerel AI model, yüksek kalite, key gerekmez',
    onb_tts_eleven_desc: 'Premium kalite, doğal sesler',
    onb_tts_openai_desc: 'Hızlı, kararlı, kaliteli sesler',
    onb_tts_spesh_desc: 'ElevenLabs uyumlu, premium sesler',
    onb_tts_dub_desc: 'Alternatif TTS sağlayıcı',
    onb_quality: 'Kalite',
    onb_voice_title: 'Sesini Seç',
    onb_voice_desc: 'Bir ses seçin ve önizleme dinleyin.',
    onb_voice_api_note: 'Sesler, API anahtarı Ayarlar\'da yapılandırıldıktan sonra kullanılabilir olacak.',
    onb_speed: 'Konuşma Hızı',
    onb_visual_title: 'Görsel Kaynağını Seç',
    onb_visual_desc: 'Sahne görselleri nereden gelsin?',
    onb_vis_pexels_desc: 'Pexels kütüphanesinden ücretsiz stok video klipler',
    onb_vis_zimage_desc: 'KIE.AI ile AI üretimi görseller',
    onb_vis_dalle_desc: 'OpenAI DALL-E 3 ile AI görsel üretimi',
    onb_vis_poll_desc: 'Ücretsiz AI görsel üretimi, key gerekmez',
    onb_style_title: 'Video Stilini Belirle',
    onb_style_desc: 'Çözünürlük, efektler ve altyazı animasyonlarını yapılandırın.',
    onb_resolution: 'Çözünürlük',
    onb_subtitle_anim: 'Altyazı Animasyonu',
    onb_video_effect: 'Video Efekti',
    onb_font: 'Altyazı Fontu',
    onb_composer: 'Video Motoru',
    onb_simple: 'Basit',
    onb_advanced: 'Gelişmiş',
    onb_complete_title: 'Kurulum Tamamlandı!',
    onb_complete_desc: 'Tüm ayarları daha sonra Ayarlar sayfasından değiştirebilirsiniz.',
    onb_preview_title: 'Çıktı Önizleme',
    onb_preview_audio: 'Ses Önizleme',
    onb_preview_voice: 'Ses',
    onb_preview_speed: 'Hız',
    onb_preview_listen: 'Önizlemeyi Dinle',
    onb_preview_generating: 'Oluşturuluyor...',
    // Gallery
    // Wizard Config Step Names
    onb_wizard_step_welcome: 'Hoşgeldin',
    onb_wizard_step_channel: 'Kanal Kurulumu',
    onb_wizard_step_tts_provider: 'Ses Sağlayıcı',
    onb_wizard_step_voice_select: 'Ses Seçimi',
    onb_wizard_step_visual_provider: 'Görsel Sağlayıcı',
    onb_wizard_step_video_style: 'Video Stili',
    onb_wizard_step_tts_advanced: 'TTS Gelişmiş',
    onb_wizard_step_subtitle_detail: 'Altyazı & Kamera',
    onb_wizard_step_ai_system: 'AI & Sistem',
    onb_wizard_step_api_keys: 'API Anahtarları',
    onb_wizard_step_notifications: 'Bildirimler',
    onb_wizard_step_social_meta: 'Sosyal Medya',
    onb_wizard_step_youtube_oauth: 'YouTube',
    onb_wizard_step_module_tts: 'Modül Seslendirme',
    onb_wizard_step_module_settings: 'Modül Ayarları',
    onb_wizard_step_summary: 'Özet',
    gallery_title: 'Video Galerisi',
    gallery_search: 'Ara...',
    gallery_all: 'Tümü',
    gallery_completed: 'Tamamlanan',
    gallery_failed: 'Başarısız',
    gallery_all_modules: 'Tüm Modüller',
    gallery_all_channels: 'Tüm Kanallar',
    gallery_default_channel: 'Varsayılan',
    gallery_results: 'sonuç',
    gallery_empty: 'Henüz video üretilmemiş',
    gallery_load_more: 'Daha fazla',
    onb_summary_channel: 'Kanal',
    onb_summary_tts: 'Ses Motoru',
    onb_summary_visual: 'Görsel Kaynağı',
    onb_summary_style: 'Video Stili',
    onb_create_first: 'İlk Videomu Oluştur!',
    onb_go_dashboard: 'Dashboard\'a Git',
    onb_tts_advanced_title: 'TTS Gelişmiş Ayarlar',
    onb_tts_advanced_desc: 'Ses sentezi ayarlarını ince ayar yapın',
    onb_remove_apostrophes: 'Apostrofleri Kaldır',
    onb_remove_apostrophes_desc: 'Mikro duraklamaları önlemek için apostrofleri temizle',
    onb_trim_silence: 'Sessizliği Kırp',
    onb_trim_silence_desc: 'Ses dosyasının başındaki/sonundaki sessizliği kaldır',
    onb_tts_enhance: 'AI ile İyileştir',
    onb_tts_enhance_desc: 'Gemini ile vurgu ve duraklamalar ekle',
    onb_tts_workers: 'Eşzamanlı Worker',
    onb_spesh_language: 'Dil Kodu',
    onb_spesh_voice_id: 'Ses ID',
    onb_subtitle_detail_title: 'Altyazı ve Kamera Detayları',
    onb_subtitle_detail_desc: 'Altyazı görünümünü ve kamera hareketlerini özelleştirin',
    onb_sub_size: 'Altyazı Boyutu',
    onb_sub_color: 'Altyazı Rengi',
    onb_sub_bg: 'Altyazı Arkaplanı',
    onb_sub_stroke: 'Metin Çerçevesi',
    onb_karaoke_enabled: 'Karaoke Modu',
    onb_karaoke_desc: 'Kelimeler söylenirken vurgula',
    onb_karaoke_color: 'Karaoke Vurgu Rengi',
    onb_transition_dur: 'Geçiş Süresi',
    onb_ken_burns_zoom: 'Ken Burns Zoom',
    onb_ken_burns_dir: 'Ken Burns Yönü',
    onb_ai_system_title: 'AI ve Sistem Ayarları',
    onb_ai_system_desc: 'Script üretimi ve sistem performansını yapılandırın',
    onb_target_audience: 'Hedef Kitle',
    onb_target_audience_ph: 'ör. 1K altı abone hedefleyen yeni YouTuber\'lar',
    onb_script_humanize: 'Script İnsanlaştır',
    onb_script_humanize_desc: 'Gemini ile scripti doğal konuşmaya dönüştür',
    onb_gpu_encoding: 'GPU Kodlama',
    onb_subtitle_provider: 'Altyazı Sağlayıcı',
    onb_remotion_concurrency: 'Remotion Eşzamanlılık',
    onb_api_keys_title: 'API Anahtarları',
    onb_api_keys_desc: 'Çeşitli servisler için API anahtarlarınızı girin (opsiyonel, daha sonra eklenebilir)',
    onb_yt_api_key_desc: 'Rakip analizi taraması için',
    onb_pixabay_desc: 'Alternatif stok görseller',
    onb_youtube_title: 'YouTube ve Yayınlama',
    onb_youtube_desc: 'YouTube yükleme ve sosyal medya yayınlama ayarlarını yapılandırın',
    onb_autopublish_yt: 'YouTube\'a otomatik yükle',
    onb_yt_privacy: 'Varsayılan Gizlilik',
    onb_yt_category: 'YouTube Kategorisi',
    onb_notif_title: 'Bildirimler',
    onb_notif_desc: 'Video tamamlanma/hata bildirimleri için kanal ayarlayın',
    onb_social_meta_title: 'Sosyal Medya Metadata',
    onb_social_meta_desc: 'Videolarınız için otomatik sosyal medya metadata üretin',
    onb_social_yt_video: 'YT Videolar için etkinleştir',
    onb_social_bulletin: 'Bültenler için etkinleştir',
    onb_social_pr: 'Ürün İncelemeleri için etkinleştir',
    onb_social_fields: 'Metadata Alanları',
    onb_social_prompt: 'Ana Prompt',
    onb_social_prompt_ph: 'Metadata üretimi için özel talimatlar...',
    onb_social_lang: 'Metadata Dili',
    onb_module_override_title: 'Modül TTS Geçersiz Kılma',
    onb_module_override_desc: 'Her modül için farklı TTS ayarları belirleyin (boş bırakırsanız global ayarlar kullanılır)',
    onb_override_tts_provider: 'TTS Sağlayıcı',
    onb_modules_title: 'Modül Ayarları',
    onb_modules_desc: 'Bülten ve Ürün İnceleme modül varsayılanlarını yapılandırın',
    onb_bulletin_settings: 'Bülten Ayarları',
    onb_bulletin_network: 'Yayın Adı',
    onb_bulletin_style: 'Bülten Stili',
    onb_bulletin_max_items: 'Maks Haber',
    onb_bulletin_lang: 'Varsayılan Dil',
    onb_pr_settings: 'Ürün İnceleme Ayarları',
    onb_pr_style: 'İnceleme Stili',
    onb_pr_currency: 'Para Birimi',
    onb_pr_auto_tts: 'Otomatik TTS üret',
    onb_pr_master_prompt: 'Ana Prompt',
    onb_pr_master_prompt_ph: 'Özel AI çıkarım talimatları...',
    onb_pr_ai_lang: 'AI Dili',
    onb_summary_subtitle: 'Altyazı',
    onb_summary_effects: 'Efektler',
    onb_summary_notif: 'Bildirimler',
    onb_summary_modules: 'Modüller',
    // Sidebar groups
    nav_group_main: 'Ana İşlemler',
    nav_group_content: 'İçerik',
    nav_group_analytics: 'Analiz',
    nav_group_system: 'Sistem',
    nav_content_planning: 'İçerik Planlama',
    session_deleted: 'Oturum silindi',
    playlist_created: 'Playlist oluşturuldu',
    playlist_create_error: 'Playlist oluşturulamadı',
    video_deleted: 'Video silindi',
    delete_error: 'Silme hatası',
    yt_upload_started: 'YouTube yükleme başlatıldı',
    yt_upload_error: 'YouTube yükleme hatası',
    thumbnail_created: 'Thumbnail oluşturuldu',
    thumbnail_error: 'Thumbnail hatası',
    ai_metadata_created: 'AI metadata oluşturuldu',
    ai_metadata_error: 'AI metadata oluşturulamadı',
    ai_assist_applied: 'AI önerisi uygulandı',
    ai_error: 'AI hatası',
    file_type_error: 'Sadece .txt, .json, .srt dosyaları desteklenir',
    tts_preview_btn: 'TTS Önizleme Oluştur',
    tts_preview_error: 'Ses önizlemesi oluşturulamadı',
    wizard_config_saved: 'Wizard yapılandırması kaydedildi',
    wizard_config_reset: 'Wizard varsayılana sıfırlandı',
    schedule_select_video: 'Lütfen bir video seçin',
    schedule_select_date: 'Lütfen tarih seçin',
    video_scheduled: 'Video zamanlandı',
    form_field_required: 'Bu alan zorunludur',
    form_title_required: 'Lütfen bir başlık girin',
    form_min_variants: 'En az 2 varyant gerekli',
  }
};
